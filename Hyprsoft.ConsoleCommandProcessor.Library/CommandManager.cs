...
namespace Hyprsoft.ConsoleCommandProcessor.Library
{
    ...
    public class CommandManager
    {
        ...
        {
            // Attempt to retrieve our application defaults from our assembly.
            AppTitle = ((AssemblyProductAttribute)Attribute.GetCustomAttribute(Assembly.GetExecutingAssembly(), typeof(AssemblyProductAttribute), false))?.Product;
            AppVersion = new Version(((AssemblyInformationalVersionAttribute)Attribute.GetCustomAttribute(Assembly.GetExecutingAssembly(), typeof(AssemblyInformationalVersionAttribute), false))?.InformationalVersion);
            AppCompany = ((AssemblyCompanyAttribute)Attribute.GetCustomAttribute(Assembly.GetExecutingAssembly(), typeof(AssemblyCompanyAttribute), false))?.Company;
        ...
        /// </summary>
        /// <remarks>The default value is the <see cref="AssemblyProductAttribute"/> value in this assembly's manifest.</remarks>
        public string AppTitle { get; set; }

        /// <summary>
        /// Gets or sets the application version displayed when the command manager's <see cref="RunAsync"/> is invoked.
        /// </summary>
        /// <remarks>The default value is the <see cref="AssemblyInformationalVersionAttribute"/> value in this assembly's manifest.</remarks>
        public Version AppVersion { get; set; }

        /// <summary>
        /// Gets or sets the application company name displayed when the command manager's <see cref="RunAsync"/> is invoked.
        /// </summary>
        /// <remarks>The default value is the <see cref="AssemblyCompanyAttribute"/> value in this assembly's manifest.</remarks>
